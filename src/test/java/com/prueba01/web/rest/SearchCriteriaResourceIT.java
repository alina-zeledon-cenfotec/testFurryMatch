...
import com.prueba01.domain.enumeration.Sex;
import com.prueba01.repository.SearchCriteriaRepository;
...
class SearchCriteriaResourceIT {
    ...
    @Test
    @Transactional
    void checkTradePupsIsRequired() throws Exception {
        int databaseSizeBeforeTest = searchCriteriaRepository.findAll().size();
        // set the field null
        searchCriteria.setTradePups(null);
