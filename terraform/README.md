...
```
curl "https://nubesgen.com/demo.tgz?iactool=TERRAFORM&region=eastus&application=APP_SERVICE.standard&runtime=SPRING&database=MYSQL.basic&gitops=true" | tar -xzvf -
```
